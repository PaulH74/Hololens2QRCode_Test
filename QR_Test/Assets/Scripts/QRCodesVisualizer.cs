...
namespace QRTracking
{
    public class QRCodesVisualizer : MonoBehaviour
    {
        ...
        private QRCodeTrigger _QRCodeTrigger;
        ...
        void Awake()
        {
            _QRCodeTrigger = GetComponent<QRCodeTrigger>();
        }
            ...
            lock (pendingActions)
            {
                while (pendingActions.Count > 0)
                {
                    ...
                    if (action.type == ActionData.Type.Added)
                    {
                        ...
                        // Trigger Appropriate Menu
                        _QRCodeTrigger.TriggerMenu(action.qrCode.Data, qrCodeObject.transform);
                    }
